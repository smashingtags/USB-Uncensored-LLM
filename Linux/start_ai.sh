...
[ $LOCAL_ENGINES_UP -eq 1 ] && kill $LOCAL_PID 2>/dev/null; pkill -f 'ollama' 2>/dev/null; pkill -f 'llama-server' 2>/dev/null; pkill -f 'chat_server.py' 2>/dev/null
